...
#define GPS_NOT_FOUND     2
#define DHT_NOT_FOUND     3
#define BMP388_NOT_FOUND  4     
#define CO2_NOT_FOUND     5    
#define UV_NOT_FOUND      6
#define DS18B_NOT_FOUND   7
...
#define HEATER_PIN            41    // pin to run the heater
#define STATUS_LED            43     // Yellow heartbeat LED
#define HEATER_LED            35    // Red LED showing when Heater is on
